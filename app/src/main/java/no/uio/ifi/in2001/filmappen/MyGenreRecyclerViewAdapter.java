...
import no.uio.ifi.in2001.filmappen.GenreFragment.OnListFragmentInteractionListener;
...
public class MyGenreRecyclerViewAdapter extends RecyclerView.Adapter<MyGenreRecyclerViewAdapter.ViewHolder> {
    ...
    protected MyGenreRecyclerViewAdapter(List<Movie> items, OnListFragmentInteractionListener listener, Context context) {
        mValues = items;
        mListener = listener;
